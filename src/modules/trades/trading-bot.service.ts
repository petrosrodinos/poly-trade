...
export class TradingBotService {
    ...
    constructor(
        ...
        this.alpacaClient = new AlpacaClient(getAlpacaConfig());
    }
    ...
    async startBot(symbol: string): Promise<void> {
        ...
        const ws = await this.alpacaStreamingService.connectWebSocket();
    ...
    private async openPosition(symbol: string, side: 'buy' | 'sell'): Promise<void> {
        try {
