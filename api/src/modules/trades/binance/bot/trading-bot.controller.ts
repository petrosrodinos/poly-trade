...
//             await this.tradingBotService.startBot(id);
//             res.status(200).json({ message: `Binance trading bot started for ${id}` });
//         } catch (error: any) {
//             if (error instanceof z.ZodError) {
//                 handleValidationError(error, res);
//                 return;
...
//                 await this.tradingBotService.stopBot(id);
//             res.status(200).json({ message: `Binance trading bot stopped for ${id}` });
//         } catch (error: any) {
//             if (error instanceof z.ZodError) {
//                 handleValidationError(error, res);
//                 return;
